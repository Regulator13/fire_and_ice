...
//create buttons
scr_create_button(room_width/2, hb+s*yb++, "lobby", "play", true)
scr_create_button(room_width/2, hb+s*yb++, "online", "online", true)
scr_create_button(room_width/2, hb+s*yb++, "options", "options", true)
